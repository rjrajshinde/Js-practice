...
// Notice that we can also pass variables, which allows us even greater 
...
// an argument. Modify the function by using push() and unshift() to 
// add 'I', 2, 'three' to the beginning of the array and 7, 'VIII', 9 to the 
// end so that the returned array contains representations of the numbers 1-9 in 
// order.
